  ...
  <aside class="w-full h-full border-l border-border overflow-y-auto bg-white flex flex-col">
    ...
    >
      ...
      <p class="text-xs text-muted-foreground">
        Haz clic en un círculo del mapa o en una zona de la lista
      </p>
    </div>
      ...
      <div class="p-4 space-y-4 flex-1 overflow-y-auto">
        ...
        <div class="bg-accent rounded-lg p-4 border border-green-200">
          <div class="flex items-center gap-2 mb-3">
            ...
            <h3 class="text-sm text-green-900 font-semibold">
              ¿Por qué se recomienda esta zona?
            </h3>
          </div>
          <ul class="space-y-2">
            ...
            <li
              v-else
              class="text-sm text-green-800 italic"
            >
            ...
            <div class="bg-white border border-border rounded-lg p-3 flex items-center gap-3">
              ...
              <div class="min-w-0 flex-1">
                ...
                <p class="text-sm font-semibold text-foreground">
                  {{ formatMetric(zone.population_density, 'hab/km²') }}
                </p>
              </div>
            </div>
            ...
            <div class="bg-white border border-border rounded-lg p-3 flex items-start gap-3">
              ...
              <div class="min-w-0 flex-1">
                ...
                <p class="text-sm font-semibold text-foreground mb-1.5">
                  {{ formatMetric(zone.road_density, 'm/km²') }}
                </p>
